	...
	public int compare(Point p1, Point p2) {
		if (p1.equals(p2)) {
			return 0;
				...
				|| (!p1.equals(referencePoint) && !p2.equals(referencePoint) && (comparePolarAngle(
						p1, p2) < 0))
	...
	public int comparePolarAngle(Point p1, Point p2) {
		if (p1.equals(p2)) {
			return 0;
				...
				|| (crossProduct(p1, referencePoint) < crossProduct(p2,
						referencePoint))) {
			return -1;
		} else {
			return 1;
	...
	public int compareDistance(Point p1, Point p2) {
		if (dotProduct(p1, referencePoint) == dotProduct(p2, referencePoint)) {
			return 0;
				...
				|| (dotProduct(p1, referencePoint) < dotProduct(p2,
						referencePoint))) {
			return -1;
		} else {
			return 1;
